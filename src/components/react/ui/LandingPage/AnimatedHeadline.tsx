...
const HEADLINE: Array<HeadLine> = [
  {
    message: 'print("We are back!")',
    iconName: "fluent:sparkle-32-filled",
    iconAnimation: "animate-bounce",
    iconColor: "#ffc801",
    iconAnimationDuration: "0.75s",
  },
  {
    message: 'print("Hello world")',
    iconName: "noto-v1:globe-showing-asia-australia",
...
if (today.getDate() === 25 && today.getMonth() === 11) {
  HEADLINE.push(
    {
      message: "We wish you merry christmas.",
      iconName: "streamline-emojis:christmas-tree",
      iconAnimation: "animate-pulse",
      iconColor: "#22ffaa",
      iconAnimationDuration: "0.75s",
    },
    {
      message: "Jingle bells, jingle bells Jingle all the way.",
      iconName: "fluent:sparkle-32-filled",
      iconAnimation: "animate-spin",
      iconColor: "#ffc801",
      iconAnimationDuration: "0.75s",
...
const AnimatedHeadLine = () => {
  ...
  const showIcon = () => {
    ...
    return (
      <div
        className={`inline-block ${HEADLINE[headLineIndex].bounce !== false ? "animate-bounce" : ""}`}
  ...
  const createHeadlinePlaylist = useCallback((): Array<number> => {
    ...
    for (let i = 0; i < HEADLINE.length; i++) {
      ...
      while (
        ...
        (i === 0 && randomIndex === LAST_INDEX_PLAYLIST)
      ) {
